...
env_name = "C:/Users/user110/Desktop/Unity-TD3-Mytest/Unity-TD3/Env_Train/Test"  # Name of the Unity environment binary to launch
...
for i_episode in range(1, max_episodes+1):
    ...
    agent.save(directory = './save_My./exp1./')
...
reward_curve.to_csv('C:/Users/user110/Desktop/Unity-TD3-Mytest/Unity-TD3/rl/TD3_original/save_My/exp1/scores_td3_original.csv')

## 保存success到success_td3_original.csv文件 
name = ['Value']
reward_curve = pd.DataFrame(columns=name,data=success)
reward_curve.to_csv('C:/Users/user110/Desktop/Unity-TD3-Mytest/Unity-TD3/rl/TD3_original/save_My/exp1/success_td3_original.csv')
...
agent.load(directory = './save_My./exp1./')
scores = []
success = []
collision = []
lost = []
